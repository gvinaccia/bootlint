...
The project's coding style is laid out in the JSHint and ESLint configurations. Add unit tests for any new or changed functionality. Lint and test your code using [Grunt](http://gruntjs.com/).
